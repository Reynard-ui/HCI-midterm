...
const menuItems = [
  {
    ...
    category: "breads",
    price: 8.50,
    description: "Slow-fermented 24-hour sourdough with a deep caramel crust and open, chewy crumb.",
    image: "https://images.unsplash.com/photo-1744168673852-1d2b63dbc39f?w=400&q=80"
  },
  {
    id: 2,
    ...
    image: "https://images.unsplash.com/photo-1741217737063-2f036463c63d?w=400&q=80"
  },
  {
    id: 3,
    name: "Rye & Seed Loaf",
    category: "breads",
    price: 9.25,
    description: "Dark rye crumb with toasted sunflower, pumpkin, and flax seeds. Dense, nutty, and hearty.",
  ...
  },
  {
    ...
    category: "pastries",
    price: 5.00,
    description: "Flaky croissant dough encasing two batons of dark Valrhona chocolate.",
    image: "https://images.unsplash.com/photo-1719056947372-8a8e2fc6101e?w=400&q=80"
  },
  {
    id: 7,
    name: "Honey Cinnamon Roll",
    category: "pastries",
    price: 4.75,
    description: "Soft brioche swirled with brown sugar and cinnamon, glazed with raw wildflower honey.",
  ...
  },
  {
    ...
    category: "cakes",
    price: 6.75,
    description: "Caramelized top, custardy center — dense, silky, and made without flour.",
    image: "https://images.unsplash.com/photo-1661182355264-4910324259b6?w=400&q=80"
  },
  {
    id: 12,
    ...
    category: "cakes",
    price: 6.50,
    description: "Deep, fudgy chocolate cake with bitter cocoa, finished with a cocoa nib dusting.",
    image: "https://images.unsplash.com/photo-1706483524219-74636e2aef57?w=400&q=80"
  },
  {
    id: 13,
    ...
    category: "cakes",
    price: 5.95,
    description: "Light, moist, and fragrant with lemon glaze and a cracked sugar finish.",
    image: "https://images.unsplash.com/photo-1597987215762-c6a7f01de3c0?w=400&q=80"
  },
  {
    id: 14,
    ...
    image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/d/de/Apple_pie_44.jpg/960px-Apple_pie_44.jpg"
  },
  {
    id: 15,
    ...
    image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/69/Pumpkin_Pie_with_Cinnamon_Crust.jpg/960px-Pumpkin_Pie_with_Cinnamon_Crust.jpg"
  },
  {
    id: 16,
    name: "Chocolate Ganache Pie",
    category: "pies",
    price: 6.25,
    description: "Dark chocolate ganache in a hazelnut crust, crowned with chocolate-covered strawberries.",
    image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/b/b4/Chocolate_Mousse_Pie_with_Chocolate_Covered_Strawberries.JPG/960px-Chocolate_Mousse_Pie_with_Chocolate_Covered_Strawberries.JPG"
  }
];
...
const ITEM_ID = {
  1:  { name: 'Sourdough Pedesaan',   desc: 'Sourdough fermentasi lambat 24 jam dengan crust karamel tebal dan crumb terbuka yang kenyal.' },
  2:  { name: 'Baguette Tradisional',  desc: 'Crust keemasan renyah, bagian dalam berpori — dipanggang segar setiap pagi hingga sore.' },
  3:  { name: 'Roti Ragi & Biji-bijian', desc: 'Roti rye gelap dengan biji bunga matahari, labu, dan rami sangrai. Padat, gurih, mengenyangkan.' },
  ...
  6:  { name: 'Pain au Chocolat',      desc: 'Adonan croissant renyah membungkus dua batang cokelat hitam Valrhona.' },
  7:  { name: 'Roll Madu Kayu Manis',  desc: 'Brioche lembut berputar dengan gula merah dan kayu manis, disiram madu hutan asli.' },
  11: { name: 'Cheesecake Basque Hangus', desc: 'Atas karamelisasi, tengah creamy — padat, halus, dan dibuat tanpa tepung.' },
  12: { name: 'Kue Cokelat Tanpa Tepung', desc: 'Kue cokelat pekat dan fudgy dengan kakao pahit, ditaburi serpihan biji kakao.' },
  13: { name: 'Kue Lemon Minyak Zaitun', desc: 'Ringan, lembap, harum — glasur lemon dan lapisan gula retak.' },
  ...
  16: { name: 'Pai Ganache Cokelat', desc: 'Ganache cokelat hitam dalam crust hazelnut, dihiasi stroberi balut cokelat.' }
};
...
const I18N = {
  en: {
    ...
    slide1Tag: 'Best Seller',
    slide1Text: 'Our 24-hour fermented loaf — the one every regular walks in for. Deep caramel crust, open chewy crumb.',
    slide2Tag: "Today's Special",
    slide2Text: 'Soft brioche swirled with brown sugar and cinnamon, glazed with raw wildflower honey. This week only.',
    slide3Tag: 'Weekend Brunch',
    slide3Text: '4 butter croissants, 1 box of chocolate puff twists, and 2 coffees — boxed and ready from 8am. One of our favorite things we bake.',
    ctaBreads: 'See Breads', ctaPastries: 'See Pastries', ctaOrder: 'Order Now'
  },
  id: {
    ...
    slide1Tag: 'Terlaris',
    slide1Text: 'Roti fermentasi 24 jam kami — primadona para pelanggan setia. Crust karamel tebal, crumb terbuka dan kenyal.',
    slide2Tag: 'Special Hari Ini',
    slide2Text: 'Brioche lembut dengan gulungan gula merah dan kayu manis, disiram madu hutan asli. Hanya minggu ini.',
    slide3Tag: 'Brunch Akhir Pekan',
    slide3Text: '4 croissant mentega, 1 kotak twist puff pastry cokelat, dan 2 kopi — dikemas siap saji mulai jam 8 pagi. Salah satu yang paling kami sukai.',
    ctaBreads: 'Lihat Roti', ctaPastries: 'Lihat Pastry', ctaOrder: 'Pesan Sekarang'
  }
};
...
(function buildCheckoutUI() {
  ...
  wrap.innerHTML = `
    ...
    <!-- ORDER CONFIRMATION (full-screen, centered) -->
    <div class="confirm-overlay" id="confirmOverlay">
      <div class="confirm-card">
        <div class="confirm-logo" id="confirmLogo"><span>🌾</span></div>
...
(function initSlideshow() {
  ...
  const slideDefs = [
    { id: 1, tagKey: 'slide1Tag', textKey: 'slide1Text', ctaKey: 'ctaBreads', link: 'menu.html?cat=breads' },
    { id: 7, tagKey: 'slide2Tag', textKey: 'slide2Text', ctaKey: 'ctaPastries', link: 'menu.html?cat=pastries' },
    { id: 4, tagKey: 'slide3Tag', textKey: 'slide3Text', ctaKey: 'ctaOrder', link: 'menu.html?cat=pastries' }
  ];
  ...
  function slideData() {
    return slideDefs.map(d => ({
      ...
      title: menuName(d.id),
      text: t(d.textKey),
      image: menuItems.find(i => i.id === d.id).image,
      cta: t(d.ctaKey),
      link: d.link
    }));
  }
  ...
  function buildSlides() {
    track.innerHTML = slideData().map(s => `
      <div class="slide">
